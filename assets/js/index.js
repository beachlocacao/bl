...
const reviews = [
      {
        ...
        estrelas: 5,
        comentario: "Excelente atendimento! Produto chegou antes do prazo."
      },
      {
        nome: "Carlos Mendes",
        imagem: "https://randomuser.me/api/portraits/men/36.jpg",
        estrelas: 4,
        comentario: "Serviço bom, mas poderia melhorar o tempo de entrega."
      },
      {
        nome: "Ana Souza",
        imagem: "https://randomuser.me/api/portraits/women/68.jpg",
        estrelas: 3,
        comentario: "O produto é bom, mas demorou um pouco para chegar."
      },
      {
        nome: "Ricardo Lima",
        imagem: "https://randomuser.me/api/portraits/men/12.jpg",
        estrelas: 5,
        comentario: "Muito bom! Atendimento ágil e de qualidade."
      },
      {
        nome: "Beatriz Rocha",
        imagem: "https://randomuser.me/api/portraits/women/12.jpg",
        estrelas: 4,
        comentario: "Gostei bastante, voltaria a comprar com certeza."
      },
      {
        nome: "Felipe Martins",
        imagem: "https://randomuser.me/api/portraits/men/45.jpg",
        estrelas: 5,
        comentario: "Tudo perfeito! Ótima experiência do início ao fim."
      }
    ];
    ...
    reviews.forEach(review => {
      ...
      div.innerHTML = `
        ...
        <div class="review-name">${review.nome}</div>
